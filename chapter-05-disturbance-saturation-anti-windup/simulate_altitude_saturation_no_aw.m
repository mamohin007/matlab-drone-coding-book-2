function results = simulate_altitude_saturation_no_aw(sim, params, gains, z_ref, vz_ref, az_ref, disturbance, limits)
...
for k = 1:n-1
    ...
    % Integral update without anti-windup
    ...
    % Commanded thrust before saturation
